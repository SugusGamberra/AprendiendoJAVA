...
public class Persona {
	...
	public static String getPropiedadComun() {
		return propiedadComun;
	}

	public static void setPropiedadComun(String propiedadComun) {
		Persona.propiedadComun = propiedadComun;
	}
